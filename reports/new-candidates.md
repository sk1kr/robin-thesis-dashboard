...
|---:|---|---|---|---|
| 1 | BKR | 데이터센터 전력 수요가 터빈·서비스 주문과 장기 RPO로 반복 전환되면 에너지 장비판 AVGO형 병목 기업이 될 수 있다. | AI power equipment | `강화 Watch`; 65 돌파 대기 |
| 2 | APH | 고속 interconnect가 AI 장비 전반의 반복 병목이 되면 고객·제품군을 확장하는 AVGO형 부품 플랫폼이 될 수 있다. | AI interconnect | `강화 Watch`; 84 돌파 대기 |
| 3 | ANET | AI cluster가 커질수록 Ethernet switching·EOS가 반복 구매되는 병목 계층이어서 AVGO형 인프라 compounder가 될 수 있다. | AI networking | `강화 Watch`; 행사·197 확인 |
| 4 | ALAB | retimer·fabric switch·smart cable이 AI 서버 데이터 이동의 표준 병목이 되면 차세대 AVGO형 connectivity platform이 될 수 있다. | AI connectivity | `주의 Watch`; 급등 추격 금지 |
| 5 | PWR | 전력망·대형 부하 backlog가 AI 데이터센터 투자와 누적되면 grid 실행판 RKLB형 복리 후보가 될 수 있다. | Power grid contractor | `유지 Watch`; 추세 회복 대기 |
...
- `Money Flow`: `AI networking/connectivity -> data-center power/grid -> space infrastructure -> 선택적 AI software` 순이다. AVGO의 강한 AI 전망과 ALAB 급등은 connectivity 관심을 확인하지만 바스켓 전체 추격 신호는 아니다.
- `Thesis`: accelerator·networking·전력 구조 수요는 강화 유지다. BKR·PWR은 backlog 현금전환, APH·ANET·ALAB은 고객 다변화·마진·제품 ramp로 검증한다.
- `Stock`: power equipment는 BKR, 다변화 interconnect는 APH, Ethernet은 ANET, 순수 connectivity는 ALAB, grid 실행은 PWR이 적합하다.
...
- 반복 편입 축은 `network/interconnect`, `power/grid`, `memory/AI silicon`, `space/defense`다.
- 직접 수혜는 ANET·ALAB·APH와 BKR·PWR, 2차 수혜는 MRVL·COHR·LITE와 GEV·VRT·FIX·CECO다.
...
|---|---:|---|---|---|
| BKR | 86 | 63.50 / 약 63.4 / 약 62.8 / 약 59.9 | 63 재지지 후 65 돌파·거래량 확장 | 세 추세선 위지만 -0.3%로 정체했고 돌파 수요가 확인되지 않았다. |
| APH | 83 | 82.78 / 약 81.3 / 약 80.7 / 약 80.6 | 82 재지지 후 84 돌파·거래량 확장 | 추세선 위지만 +0.9% 반등만으로 분할 후 새 base가 확정되지 않는다. |
| ANET | 81 | 193.78 / 약 194.4 / 약 191.2 / 약 182.6 | 194 재지지·197 돌파 후 거래량 확장 | 20DMA 경계이고 행사 전 기대 매수는 최소 1:3을 훼손한다. |
| ALAB | 69 | 310.40 / 약 300 / 약 299 / 약 332 | 300 재지지 후 322 돌파, 이후 332 회복 | 하루 +9.8% 급등했고 50DMA 아래다. 변동성·고객집중 위험이 남는다. |
| PWR | 68 | 624.41 / 약 647 / 약 635 / 약 654 | 620 base 후 647 회복 | 세 추세선 아래이고 낙폭만으로 수요 회복을 확인할 수 없다. |

### Risk/Reward, Kill Condition, Upcoming Catalysts

- BKR: 65 돌파·재지지 진입, 62.8 손절, 71.6 이상 목표일 때 1:3. Kill Condition은 IET orders/RPO 둔화·FCF 악화 또는 62.8 이탈. Catalyst는 data-center power awards와 RPO 전환이다.
- APH: 84 돌파·재지지 진입, 81.5 손절, 91.5 이상 목표일 때 1:3. Kill Condition은 organic 성장·book-to-bill 훼손 또는 81.5 이탈. Catalyst는 Q3 가이던스 달성과 AI interconnect 수요다.
- ANET: 197 돌파·재지지 진입, 192 손절, 212 이상 목표일 때 1:3. Kill Condition은 cloud titan 주문·가이던스 훼손 또는 183.75 이탈. Catalyst는 9월 8일·10일 행사다.
...
|---|---|---|---|
| CECO | 데이터센터 냉각·산업 환경설비가 병목화되면 숨은 picks-and-shovels 복리 후보가 될 수 있다. | backlog, data-center 매출, 현금전환 | 50DMA 회복과 거래량 확정 전 승격하지 않는다. |
| AMSC | grid 장비와 방산 수요가 반복 주문으로 연결되면 소형 전력 병목 플랫폼이 될 수 있다. | book-to-bill, grid 성장, 현금흐름 | 20DMA·50DMA 회복 전 낙폭 매수하지 않는다. |
...
3. ANET - Money Flow 20/20, Thesis 30/30, Stock 15/15, Timing 7/20, Risk/Reward 9/15 = 81. AI Ethernet Thesis는 강하지만 20DMA·행사 확인 전이다.
...
- [Baker Hughes Q2 2026 공식 실적](https://investors.bakerhughes.com/news/press-releases/news-details/2026/Baker-Hughes-Announces-Second-Quarter-2026-Results/default.aspx)
- [Amphenol Q2 2026 공식 실적](https://investors.amphenol.com/news-and-events/news-details/2026/Amphenol-Reports-Record-Second-Quarter-2026-Results/default.aspx)
- [KIND 신규상장 공개 목록](https://kind.krx.co.kr/)
